...
ol.Popover = function (map, params) {
  ...
  this.container = create('div', this.options['className'])
  this.content = create('div', 'hmap-js-popup-content', this.container)
  this.content.style.maxHeight = size[1] - 20 + 'px'
  if (this.options['showCloser'] !== false) {
    this.closer = create('div', 'hmap-js-popup-closer', this.container)
  ...
  if (this.options['showMinimize'] !== false) {
    this.minimize = create('div', 'hmap-js-popup-minimize', this.container)
  ...
  ol.Overlay.call(this, {
    ...
    insertFirst: ((this.options.hasOwnProperty('insertFirst')) ? this.options.insertFirst : false)
  })
}
...
ol.Popover.prototype.showMinimize = function () {
  ...
  if (this.options['showMarkFeature']) {
    if (!this.miniOverLay) {
      let element = create('span', 'hmap-marker-minimize-panel')
      ...
      let label = create('label', 'hmap-marker-minimize-label', element)
 ...
 * @returns {ol.Popover}
 */
ol.Popover.prototype.hide = function (clear) {
  this.container.style.display = 'none'
  if (clear && this && this.options['id']) {
    this.map.removeOverlay(this)
  }
  return this
}
